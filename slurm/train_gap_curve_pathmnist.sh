#!/bin/bash
#SBATCH --job-name=gap_curve_pathmnist
...
# Generalization-gap-vs-graph-size curve for PathMNIST (Gap 1).
...
# one row per (size, seed) to results/gap_curve/pathmnist.csv.
...
# prerequisite as train_gnn_pathmnist.sh.
echo "Starting Gap-1 curve training (PathMNIST)..."
