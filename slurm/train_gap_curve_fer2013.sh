#!/bin/bash
#SBATCH --job-name=gap_curve_fer2013
...
# Generalization-gap-vs-graph-size curve for FER2013 (Gap 1).
...
# one row per (size, seed) to results/gap_curve/fer2013.csv.
...
# prerequisite as train_gnn_fer2013.sh.
echo "Starting Gap-1 curve training (FER2013)..."
