...
# Start the W&B agent for OCTMNIST
...
# then replace REPLACE_WITH_OCTMNIST_SWEEP_ID below with the printed sweep ID.
...
python src/scripts/train_model.py \
    -d config/datasets/octmnist.yaml \
