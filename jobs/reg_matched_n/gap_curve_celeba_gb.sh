...
# Otherwise identical to jobs/matched_n/gap_curve_celeba_gb.sh. Results land in
...
# the earlier jobs/matched_n/gap_curve_celeba_gb_reg.sh run (different fraction/
...
# directly (bash gap_curve_celeba_gb.sh) / in the background (nohup ... &).
#
