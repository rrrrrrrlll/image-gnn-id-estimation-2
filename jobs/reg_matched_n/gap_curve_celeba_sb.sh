...
# Otherwise identical to jobs/matched_n/gap_curve_celeba_sb.sh. Results land in
...
# the earlier jobs/matched_n/gap_curve_celeba_sb_reg.sh run (different fraction/
...
# directly (bash gap_curve_celeba_sb.sh) / in the background (nohup ... &).
#
