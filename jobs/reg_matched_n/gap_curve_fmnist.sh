...
# Otherwise identical to jobs/matched_n/gap_curve_fmnist.sh. Results land in
...
# the earlier jobs/matched_n/gap_curve_fmnist_reg.sh run (different fraction/
...
# directly (bash gap_curve_fmnist.sh) / in the background (nohup ... &).
#
