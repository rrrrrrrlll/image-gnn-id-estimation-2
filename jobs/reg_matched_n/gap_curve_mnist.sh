...
# Otherwise identical to jobs/matched_n/gap_curve_mnist.sh. Results land in
...
# the earlier jobs/matched_n/gap_curve_mnist_reg.sh run (different fraction/
...
# directly (bash gap_curve_mnist.sh) / in the background (nohup ... &).
#
