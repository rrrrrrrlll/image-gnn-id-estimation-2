...
# Otherwise identical to jobs/matched_n/gap_curve_cifar10.sh. Results land in
...
# the earlier jobs/matched_n/gap_curve_cifar10_reg.sh run (different fraction/
...
# directly (bash gap_curve_cifar10.sh) / in the background (nohup ... &).
#
