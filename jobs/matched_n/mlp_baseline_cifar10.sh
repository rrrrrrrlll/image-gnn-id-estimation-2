#!/bin/bash
# Matched-training-size MLP baseline for cifar10 (Gap 2).
#
...
# directly (bash mlp_baseline_cifar10.sh) / in the background (nohup ... &).
#
...
mkdir -p log
exec > >(tee -a "log/mlp_cifar10.log") 2>&1

echo "Starting matched-n MLP baseline training (cifar10)..."
