#!/bin/bash
# Matched-training-size gap curve for fer2013 (Gap 1) using GNNProjModel --
...
# results?). Otherwise identical to gap_curve_fer2013.sh.
#
...
mkdir -p log
exec > >(tee -a "log/gap_fer2013_proj.log") 2>&1

echo "Starting matched-n gap-curve training (GNNProjModel, fer2013)..."
